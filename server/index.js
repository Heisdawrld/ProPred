...
const statsBlock = (hS && aS) ? ` COMPUTED STATS (from actual match data): ${homeTeam}: avg scored ${hS.avg_scored} | avg conceded ${hS.avg_conceded} | avg total goals ${hS.avg_total} | BTTS ${hS.btts}/${hS.n} | Over 2.5: ${hS.over25}/${hS.n} | Over 1.5: ${hS.over15}/${hS.n} | Clean sheets: ${hS.cleanSheets}/${hS.n} ${awayTeam}: avg scored ${aS.avg_scored} | avg conceded ${aS.avg_conceded} | avg total goals ${aS.avg_total} | BTTS ${aS.btts}/${aS.n} | Over 2.5: ${aS.over25}/${aS.n} | Over 1.5: ${aS.over15}/${aS.n} | Clean sheets: ${aS.cleanSheets}/${aS.n} H2H avg goals: ${h2hAvg||'N/A'} | H2H BTTS: ${h2hBTTS}/${h2h.length}` : ‘’;
